/*
    ...
    OpenGL loader generated by glad 0.1.13a0 on Fri Mar 17 22:36:42 2017.
...
static int get_exts(void) {
	...
	if (max_loaded_major < 3) {
		...
		if (num_exts_i > 0) { exts_i = (const char **)realloc((void *)exts_i, num_exts_i * sizeof *exts_i); }

		if (exts_i == NULL) { return 0; }

		for (index = 0; index < num_exts_i; index++) { exts_i[index] = (const char*)glGetStringi(GL_EXTENSIONS, index); }
	}
#endif
	return 1;
}
