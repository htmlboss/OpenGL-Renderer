...
/***********************************************************************************/
Texture::Texture(const std::string& TexturePath, const std::string& samplerName, const ColorMode colorMode) : m_texturePath(TexturePath.c_str()), m_samplerName(samplerName) {
